        ...
        <el-row :gutter="24">
            <el-col :span="6">
                ...
                <el-col :span="6">
                    <el-card shadow="always" style="text-align:center">
                        <div>
                            <a href="https://github.com/CocoJob/CocoJob" target="_blank">{{$t('message.githubURL')}}</a>
                        </div>
                        <div>
                            <a href="https://github.com/CocoJob/CocoJob/wiki" target="_blank">{{$t('message.docURL')}}</a>
                        </div>
                    </el-card>
                </el-col>
            <el-col :span="6">
