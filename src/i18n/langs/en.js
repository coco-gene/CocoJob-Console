...
const en = {
    message: {
        ...
        'email': 'Email',
        'webhook': 'Webhook',
        'welcomeTitle': 'Welcome to use CocoJob!',
        'login': 'Login',
        'logout': 'Logout',
        ...
        'javaProcessorInfoPLH': 'Classname, eg: com.yunqiic.cocojob.HelloWordProcessor',
        'containerProcessorInfoPLH': 'ContainerID#classname, eg: 1#com.yunqiic.cocojob.HelloWordProcessor',
